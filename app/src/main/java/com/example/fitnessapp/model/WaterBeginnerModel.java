...
public class WaterBeginnerModel {
   public String date, time, repeat, repeatNo, dailyWater,title;

    public WaterBeginnerModel() {
    }

    public WaterBeginnerModel(String date, String time, String repeat, String repeatNo, String dailyWater, String title) {
        this.date = date;
        this.time = time;
        this.repeat = repeat;
